...
**Definition:** The $M$'s principal diagonal of index $d$, for $0 \le d \le m + n -2$, is the set of entries$$L(d) =\begin{cases}\{M[0, d], M[1, d-1], \ldots M[d, d )\} & \text
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5MzgxNzE1LDcwNzUyMzgxNSwtODM1MD

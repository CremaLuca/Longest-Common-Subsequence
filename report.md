...
Once the $M$ matrix has been computed by the parallel algorithm, process $P(m-1, n-1) = 0$ knows entry $M[m-1, n-1]$, i.e. the length of an LCS. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MTUxOTQ4NywtOTg5MjUwOTA5LDEzMj

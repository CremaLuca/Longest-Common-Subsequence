...
As the size of the two input strings $X$ and $Y$ Each process store the whole matrix, it will only store the cells it computed and the ones from other processors that it used for its computations. An efficient data structure is required.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzNDcxNTA4MCwxNjQ1MTM0MTcxLDIwMz
...
MDgxNTUxLC01MzEzNTEwMSwxMTkyMzQ3MDc1LDgxNTE3OTkzOC
wtMTA4MTU5NjY4OCwyMDk1NDg3OTg2LC0xMTU3NTUzODgyLC04
OTA2OTA2MTZdfQ==
-->
...
{if $i < L(d) \mod P$}  \\(L(d) \mod P) \cdot \lfloor \frac{L(d)}{P} \rfloor + (i - (L(d) \mod P)) * \lceil \frac{L(d)}{P} \rceil & \text{otherwise} \end{cases}$$
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMTExNDg5OTQsLTI3OTgzMzc1MSwxNT

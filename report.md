...
# TODO (X marco)
Each processor needs to know which entries to compute. We make use of the observations above, i.e. the procedure $\text{diagonalstartend()}$
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI4NDUxMTg5NSwtODc5MjU5MjUwLC0yMD

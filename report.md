...
Once the $M$ matrix has been computed by the parallel algorithm, process $P(m-1, n-1) = 0$ knows entry $M[m-1, n-1]$, i.e. the length of an LCS. To reconstruct it, 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5ODMxNTk3LC05ODkyNTA5MDksMTMyMD

...
In this case *every* cell of *each* diagonal is assigned to a *different* processor. And it's easy to see that to compute entry $(i, j)$, processor $P(i, j)$, needs 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEyODA0MzQ3NSwtMTAxNTA1MDEwMywtMz
...
NjQ5OTksNDAzMDQ1Mzc4LC04MDk3ODg5NTQsNTM5OTE3MTY0LD
cwNzUyMzgxNSwtODM1MDQ0MjIzLDEwMzIyMDY0MTIsLTExOTky
NTQ0NjldfQ==
-->
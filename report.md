...
Each entry in $L(d)$ will depend only on entries belonging to $L(d-1)$ and L($d-2)$. In fact each element depends only on three elements from the two previous principal diagonals. This suggests a way to parallelize our initial algorithm: by looking at the CDAG of the computation, each diagonal is a level of the greedy schedule. 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTg1NjQzMDE3LDUzOTkxNzE2NCw3MDc1Mj
M4MTUsLTgzNTA0NDIyMywxMDMyMjA2NDEyLC0xMTk5MjU0NDY5
LC0zMzQ1OTkwMDldfQ==
-->
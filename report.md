...
{$i < L(d) \mod P$}  \\\\(L(d) \mod P) \cdot\Bigl \lfloor  \frac{L(d)}{P} \Bigr\rfloor + (i - (L(d) \mod P)) \cdot \Bigl \lceil  \frac{L(d)}{P} \Bigr\rceil & \text{otherwise} \end{cases}$$
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTA1MTQ2MTQ5LC02NzgwMzk1NzEsODg4Mj

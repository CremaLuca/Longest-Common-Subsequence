...
Instead of keeping the matrix of whom is what we can devise a constant-time algorithm to find where to send the computed values. As we already mentioned in a remark, each processor needs to send at most $2$ values.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY0NzQ2MjkxNiw4Njg5NTU0NjUsMTY1MT

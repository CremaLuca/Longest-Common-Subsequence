...
Once the $M$ matrix has been computed by the parallel algorithm, process $P(m-1, n-1) = 0$ knows entry $M[m-1, n-1]$, i.e. the length of a LCS.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODE4NDUwNzcsLTk4OTI1MDkwOSwxMz

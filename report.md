...
- if $i < L(d) \mod P$, compute entries from $D[ i \lfloor \frac{L(d)}{P} \rfloor]$ to $D[(i +1)\lfloor \frac{L(d)}{P} \rfloor-1]$
	- from
	- to $
- otherwise
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY1NjczNzUyOCwxNTMyMTY0OTk5LDQwMz

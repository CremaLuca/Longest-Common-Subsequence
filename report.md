...
From this simple recurrence relation, it's easy to design a sequential algorithm that solves the LCS problem.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzNDczMDc4NCwxMDMyMjA2NDEyLC0xMT

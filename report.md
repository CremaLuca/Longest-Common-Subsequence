...
From this simple recurrence relation, it's easy to design a sequential algorithm that solves the LCS problem, filling each row one at a time. It follows that the length of a LCS is saved in $M[m-1, n-1]$. To construct the actual LCS of sequences $X_i$, $Y_j$ it's 
## Parallel algorithm
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzg0MDY5MTgzLDEwMzIyMDY0MTIsLTExOT

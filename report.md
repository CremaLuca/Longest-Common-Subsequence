...
We mention also that the sequential algorithm looks a bit more cache friendly, since the whole LCS matrix is 
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTI4Njg5MDA5LDE5MjA1NjYyMzMsLTE1MT

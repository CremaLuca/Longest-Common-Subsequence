...
**Remark:** It's quite easy to see that every processor $p$ assigned to cell $(i, j)$, during the computation of this entry,  already has the value of cell $(i-1, j-1)$ stored in its memory: in fact, since at least one of $(i, j-1)$ or $(i-1, j)$ is assigned to $p$. 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI3OTMxMTk3NSwtMTA5MzgzMzAxLC0xMD

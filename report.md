...
If $1.$ is true, then $p$ sends $x_i$ to $p' = P(i-1, j-1)$. If $2.$ is true, then $p$ sends $e$ to $p' = P(i-1, j-1)$

<!--stackedit_data:
eyJoaXN0b3J5IjpbMjM2NDg5MDAsMTk4MzU5NjczNCwxNDM5Nj
IxMTQyLDE1MTkyOTUxNzgsMTA3OTgxNTUwOSwtOTg5MjUwOTA5
LDEzMjA5NjEzNzYsLTE5NTIyMTQ2ODUsLTEyMjY0NjEzNjUsLT

...
We tested $5$ different kind of input files named small, medium, large, large_2, large_3. 
...
The CPU efficiency values are obtained from the `seff` command on CAPRI and have meaningful values only for some of the jobs, especially for those that completed the input_large3
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1OTg0NTI3MSw4NDA5MDU5OTksLTEzMT

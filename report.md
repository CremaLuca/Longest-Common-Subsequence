...
From this simple recurrence relation, it's easy to design a sequential algorithm that solves the LCS problem. It follows that 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgyNTY2MzQ2MCwxMDMyMjA2NDEyLC0xMT

...
Without loss of generality, we assume $m \le n$ in the following. We first describe a sequential algorithm for the LCS problem, and then we move to the more interesting parallel case.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUzMzk2MDU2MCwtMTE5OTI1NDQ2OSwtMz
M0NTk5MDA5XX0=
-->
...
There's a well-known algorithm based on dynamic programming, that we propose here for the sequential case Let $M$ be an $$
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ1MjM0MzEwOSwxMDMyMjA2NDEyLC0xMT

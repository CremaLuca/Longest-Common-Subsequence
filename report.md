...
We will exploit the previous recurrence relation, trying to find a way to parallelize the computation. We begin by noting that to compute each entry of $M$ belonging to some pricipal diagonal (
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc2ODUwNDIwMiw3MDc1MjM4MTUsLTgzNT
